                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <form  action="{{route('ajouterAuCart')}}" method="post" class="product-form product-form-product-template hidedropdown">
                                    ...
                                    <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                     ...
                                     <input class="swatchInput" id="swatch-0-{{$item}}" type="radio" name="option-0" value="{{$item}}"><label class="swatchLbl color small" for="swatch-0-{{$item}}" style="background-color:{{$item}};" title="{{$item}}"></label>
                                    ...
                                    <div class="swatch clearfix swatch-1 option2" data-option-index="1">
                                        <div class="product-form__item">
                                         ...
                                         <div data-value="X-Small" class="swatch-element x-small available">
                                            <input class="swatchInput" id="{{$item}}" type="radio" name="option-1" value="{{$item}}"><label class="swatchLbl small rounded" for="{{$item}}" title="{{$item}}">{{$item}}</label>
                                          </div>
                                         @endforeach
                                        </div>
                                    </div>
